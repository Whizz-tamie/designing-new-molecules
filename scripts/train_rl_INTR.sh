...
if [ "$PROFILE" == "true" ]; then
    PROFILE_DIR="/rds/user/gtj21/hpc-work/designing-new-molecules/profiles"
    mkdir -p $PROFILE_DIR
    PROFILE_FILE="$PROFILE_DIR/$SLURM_JOB_NAME.$SLURM_JOB_ID.prof"
    options="$options --profile --output_file \"$PROFILE_FILE\""
fi
...
mkdir -p /rds/user/gtj21/hpc-work/designing-new-molecules/logs/slurm
JOBNAME=$SLURM_JOB_NAME
JOBID=$SLURM_JOB_ID
LOGFILE_STDOUT="/rds/user/gtj21/hpc-work/designing-new-molecules/logs/slurm/$SLURM_JOB_NAME.$JOBID.out"
LOGFILE_STDERR="/rds/user/gtj21/hpc-work/designing-new-molecules/logs/slurm/$SLURM_JOB_NAME.$JOBID.err"
